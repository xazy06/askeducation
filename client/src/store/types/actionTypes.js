...
// PROGRAMM
export const GET_PROGRAMM = 'GET_PROGRAMM'
export const POST_PROGRAMM = 'POST_PROGRAMM'
export const DELETE_PROGRAMM = 'DELETE_PROGRAMM'
export const PUT_PROGRAMM = 'PUT_PROGRAMM'
export const GET_PROGRAMM_BY_ID = 'GET_PROGRAMM_BY_ID'
